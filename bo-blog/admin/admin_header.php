...
/*vot*/ $shutajax=(@$config['closeadminajax']=='1') ? 1 : 0;

/*vot*/ $adminclass = @$adminclassshow['message'];
/*vot*/ $messageblock=(@$flset['guestbook']!=1) ? "<span class=\"ahb{$adminclass}\"><li onmouseover=\"adminitemhover('message',this)\"><a href=\"admin.php?act=message\">{$lna[7]}</a></li></span>" : '';
$display_overall.=<<<eot
...
/*vot*/ if (@$flset['tags']!=1)  $admin_item["category"]["tags"]=$lna[17];
...
/*vot*/ if (@$flset['weather']!=1)  $admin_item["misc"]["weatherset"]=$lna[31];
/*vot*/ if (@$flset['avatar']!=1)  $admin_item["misc"]["avatar"]=$lna[32];
