    ...
    <td colspan=2  class="sect">
      ...
      <table class='tablewidth' align=center>
        <tr>
          ...
          <td>
            <input type="text" name="newcatename" value="" size="30">
          </td>
        </tr>
        <tr>
          <td width=160 valign='top'>
            {$lna[1117]} <a href="#" title="{$lna[1118]}" onclick="alert('{$lna[1118]}')">[?]</a>
          </td>
          <td>
            <input type="text" name="newcateurlname" value="" size="30" maxlength="70"> {$lna[102]}
          </td>
        </tr>
        <tr>
          <td width=160 valign=top>
          ...
          <td>
            <textarea cols=100 rows=4 name="newcatedesc"></textarea>
          </td>
        </tr>
        <tr>
          <td width=160>
        ...
        <tr>
          <td width=160 valign=top>{$lna[191]}</td>
          <td>
            <input type="text" name="newcateurl" value="" size="30"> {$lna[192]}
          </td>
        </tr>
        <tr>
          <td width=160>{$lna[193]}</td>
          <td>
            <input type="text" name="newcateicon" value="" size="30"> {$lna[194]}
          </td>
        </tr>
        <tr>
          <td width=160>{$lna[1022]}</td>
          <td>
...
<table class='tablewidth' align=center cellpadding=4 cellspacing=0>
    ...
    <td colspan=2  class="sect">
      <table class='tablewidth' align=center>
        <tr>
          ...
          <td width=50%>
            {$lna[200]}
            <input type=radio name='go' value='category_edit' onclick="swapdiv(0);">{$lna[77]}
            <input type=radio  name='go' value='category_del' onclick="swapdiv(1);">{$lna[78]}
            <input type=radio  name='go' value='category_combine' onclick="swapdiv(2);">{$lna[201]}
          </td>
        </tr>
        <tr>
          <td width=50%>&nbsp;</td>
          <td width=50%>
            ...
            <div id="targetdiv" style="display:none">
              <b>{$lna[202]}</b> <a href='admin.php?act=entry'>{$lna[203]}</a>
              <br>
  ...
  <tr>
    <td colspan=4 align=center class="sectbar"></td>
  </tr>
</table>
</form>
eot;
...
<table class='tablewidth' align=center cellpadding=4 cellspacing=0>
    ...
    <td colspan=2  class="sect">
      ...
      <table class='tablewidth' align=center cellpadding=4 cellspacing=0>
        <tr>
          <td width=160>{$lna[182]}</td>
          <td>
            <input type="text" name="newcatename" value="{$categories[$sourcecate]['catename']}">
          </td>
        </tr>
        <tr>
          <td width=160 valign='top'>
          ...
          <td>
            <input type="text" name="newcateurlname" value="{$categories[$sourcecate]['cateurlname']}" size="30" maxlength="70"> {$lna[102]}
          </td>
        </tr>
        <tr>
          <td width=160 valign=top>{$lna[183]}</td>
          <td>
            <textarea cols=100 rows=4 name="newcatedesc">{$categories[$sourcecate]['catedesc']}</textarea>
          </td>
        </tr>
        <tr>
          <td width=160>{$lna[187]}</td>
          <td>
            <select name="newcatemode">
              <option value="0" {$sel3}>{$lna[188]}</option>
              <option value="1" {$sel4}>{$lna[189]}</option>
            </select>
            {$lna[190]}
          </td>
        </tr>
        <tr>
          ...
          <td>
            <select name="newcateproperty" onchange="document.getElementById('alsoch').style.display=(document.getElementById('alsoch').style.display=='none')? 'block': 'none';">
              <option value="0" {$sel1}>{$lna[185]}</option>
              <option value="1" {$sel2}>{$lna[186]}</option>
            </select>
            {$lna[958]}
            <div id='alsoch' style="display: none;">
              {$alsochange}
            </div>
          </td>
        </tr>
        <tr>
          <td width=50 valign=top>{$lna[191]}</td>
          <td>
            <input type="text" name="newcateurl" value="{$categories[$sourcecate]['cateurl']}" size="30"> {$lna[192]}
          </td>
        </tr>
        <tr>
          <td width=50>{$lna[193]}</td>
          <td>
            <input type="text" name="newcateicon" value="{$categories[$sourcecate]['cateicon']}" size="30"> {$lna[194]}
          </td>
        </tr>
      </table>
  ...
  <tr>
    <td colspan=4 align=center class="sectbar">
      ...
      <input type=button value="{$lna[64]}" class='formbutton' onclick="catchusefuldata();">
      <input type=reset class='formbutton' value="{$lna[65]}">
    </td>
  </tr>
</table>
</form>
