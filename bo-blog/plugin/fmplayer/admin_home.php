...
if (!empty($langback)) {
    include("{$plugin_address}/lang_{$langback}.php");
} else {
    include_once("{$plugin_address}/lang_en.php");
}
...
<table class="tablewidth" align="center" cellpadding="4" cellspacing="0">
	<tr>
		...
		<td class="sectend">
			<a href="admin.php?act={$page['home']}">
			    <span class="sectstart pd3">{$lanfp[96]}{$lanfp[1]}<span class="sectend pd3"></span>
			</a>
			<a href="admin.php?act={$page['list']}">
			    <span class="sectstart pd3">{$lanfp[13]}{$lanfp[1]}</span><span class="sectend pd3"></span>
			</a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            {$lanfp[96]}{$lanfp[1]}
		</td>
