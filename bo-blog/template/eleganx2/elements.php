...
function setbgin () {
	document.getElementById('minisearcharea').style.background="url('"+absbaseurl+"template/EleganX2/images/search2.gif"+"') no-repeat";;
}
function setbgout () {
	document.getElementById('minisearcharea').style.background="url('"+absbaseurl+"template/EleganX2/images/search1.gif"+"') no-repeat";;
					...
					<div style="height:95px"><img src="template/EleganX2/images/header.jpg" border="0" width="780" height="95"></div>
				<div id="nav">
					<div id="menu">
						<ul>
...
$elements['displayfooter']=<<<eot
		...
		<div id="footer">
			<div id="innerFooter">
			<div id="innerFooter-info"><a href="http://www.jjying.cn"><img src="template/EleganX2/images/info.gif" border="0" title="Click to visitor the theme Creator's website"></a>
			</div>
