		...
		<div id="sidebar" class="sidebar">
			<div id="announce-diy">
			    <div class="announce-content">
				   ...
				   <A href="index.php?go=category_9">Theme</A>  | 
				   <A href="read.php?231">Yoci</A> | 
...
<div class="textbox">
	<div class="textbox-title">
		...
		<div class="textbox-label">
		    <div class="textbox-label-left">Category : {entrycateicon} {entrycate}</div>
...
<div class="textbox">
	<div class="textbox-title">
		...
		<div class="textbox-label">
			...
			<div class="textbox-label-right">Posted by {entryauthor}</div>
		</div>
	</div>
...
$elements['comment']=<<<eot
	<div class="commentbox">
		...
		Written by: {replier} {replieremail} {replierhomepage} {replierip}
