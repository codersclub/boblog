	   ...
	   <div id="header">
			<div id="innerHeader">
					...
					{section_head_components}
						...
						<div><input type="text" id="s" name="keyword" value="Search" onclick="if (this.value=='Search') this.value=''" title="{$lnc['enter_keywords']}" onkeypress="livesearch(event)" onfocus="setbgin()" onblur="if (this.value == '') {this.value = 'Search';}"/>
...
$elements['displayfooter']=<<<eot
		...
		<div id="footer">
			<div id="innerFooter">
            <div>{section_foot_components}Designed by <a href="http://www.underone.com/" target="_blank">Underone</a> Transplant by <a href="http://www.sayyeah.cn" target="_blank">SayYeah!</a></div>		    
			<div id="processtime">
			</div>
			</div>
		</div>
...
<div class="textbox">
	<div class="textbox-title">
		<h4>
		{entrytitle} {entryicon}
		</h4>
		<div class="textbox-label">
		    <div class="textbox-label-left">Category : {entrycate} {entrycateicon}| Post on  {entrydate} {entrytime} by {entryauthor} | <a href="{entryrelurl}#reply"> Comments:{entrycommentnum}</a></div>
	...
	<div class="textbox-bottom">
	    ...
	    <div class="textbox-bottom-right">	 {ifadmin}</div>
	{tbbar}
	{adminbar}
	</div>
</div>
...
<div class="textbox">
	<div class="textbox-title">
		...
		<div class="textbox-label">
		[{entrydate} {entrytime} | {$lnc['category']}: {entrycate} | by {entryauthor} ]
		</div>
	</div>
	...
	<div class="textbox-bottom">
	{entrycomment} | {entrytb} | {entryviews} {ifadmin}
	{tbbar}
	{adminbar}
	</div>
</div>
