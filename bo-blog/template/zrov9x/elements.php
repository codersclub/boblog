...
<html xmlns="http://www.w3.org/1999/xhtml" lang="{languagename}">
<head>
		...
		<div id="header">
			<div id="innerHeader">
				<div class="blog-header">
					<div class="blog-desc">
						<a href="javascript:void(0);" onClick="window.external.AddFavorite('http://www.206c.net','{blogname}');" class="b1">&nbsp;</a>
						<a href="mailto:zyx1315@163.com" class="b2">&nbsp;</a>
						<a href="/" class="b3">&nbsp;</a>
					</div>
				...
				<div class="search">
					<form name="searchform" method="post" action="visit.php">
						<input class="sch" type="text" id="minisearch" name="keyword" value="输入关键字搜索" onmouseover="this.select();" onfocus="this.value=='输入关键字搜索'?this.value='':'';" onblur="this.value==''?this.value='输入关键字搜索':''" onkeydown="KeyDown()" onkeyup='input()' />
...
<div id="footer"><div id="cop"></div></div>
eot;
...
$elements['sideblock_allnewsgb']='';
$elements['sideblock_newsgb']='';
...
<div class="textbox">
	<div class="textbox-title">
		...
		<h4>{entrytitle} {entryicon}</h4>
		<span>Category : <span class="mls">{entrycate} {entrycateicon}</span> | Post on  {entrydate} {entrytime} by <span class="mls">{entryauthor}</span> | <a href="{entryrelurl}#reply"> Comments:{entrycommentnum}</a></span>
	...
	<div class="textbox-label">{entrycomment} {entrytb} {entryviews} {ifadmin}</div>
{tbbar}
{adminbar}
	<div class="clear"></div>
</div>
