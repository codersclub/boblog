...
$elements['mainpage']=<<<eot
		<div id="mainWrapper">
			<div id="content" class="content">
				...
				<div class="innerContent-bottom">
					<div class="innerContent-bottom-left">
					</div>
					<div class="innerContent-bottom-right">
					</div>
				</div>
			</div>
eot;
		...
		<div id="sidebar" class="sidebar">
			<div id="innerSidebar">
			    <div id="innerSidebar-left">
				    <div id="innerSidebar-left-inner">
					{section_side_components_one}
					</div>
				</div>
			    <div id="innerSidebar-right">
				    <div id="innerSidebar-right-inner">
...
<div class="textbox">
	<div class="textbox-title">
		...
		[{entrydate} {entrytime} | Author: {entryauthor} ]
		</div>
	</div>
...
<div class="textbox">
	<div class="textbox-title">
		...
		<div style="float: right; text-align:right; width: 6%;"><a href="javascript: showhidediv('{topid}');"><img src="{$template['images']}/folder.gif" border="0" alt="" title="{$lnc[236]}" /></a></div>
...
<div class="textbox">
	<div class="textbox-title">
		<h4>
		{entrystar} {entrytitle} {entryicon} 
		</h4>
		...
		<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" class="formbox-comment">
			...
			<tr>
				...
				<td class="formbox-comment-content" valign="top">
					...
					{ubbcode}
					{if_securitycode_begin}<script>securitycodejs="{$lnc[249]} <span id='securityimagearea'><img src='inc/securitycode.php?rand={rand}' alt='' title='{$lnc[250]}'/></span> <input name='v_security' id='v_security' type='text' size='4' maxlength='4' class='text' /> {$lnc[251]}   [<a href=\"javascript: refreshsecuritycode('securityimagearea', 'v_security');\">{$lnc[283]}</a>]";</script>  {if_securitycode_end}
