...
$elements['displayfooter']=<<<eot
		...
		<div id="footer">
			<div id="innerFooter">
				{section_foot_components}<br/>
	Style By <a href="http://www.gamepallas.com/blog" target="_blank">Celin.Fox </a>
			<div id="processtime">
			</div>
			</div>
		</div>
...
<div class="textbox">
	<div class="textbox-title">
		...
		{entrystar}  <img src="template/living/images/lable01.gif" alt="" />  {entrydate} {entrytime} <img src="template/living/images/lable01.gif" alt="" /> {entryauthor}
		</div>
	</div>
