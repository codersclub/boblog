		...
		<div id="header">
			<div id="innerHeader">
				...
				<div class="blog-header">
					 <a href="index.php"><img src="{$template['images']}/logo.gif" border="0" alt="{blogname}"/></a>
				...
				<div id="menu">
					...
					{section_head_components}
						...
						<div><input type="text" id="s" name="keyword" value="Search" onclick="if (this.value=='Search') this.value=''" title="You can press Enter" onkeypress="livesearch(event)" onfocus="setbgin()" onblur="if (this.value == '') {this.value = 'Search';}"/>
...
$elements['displayfooter']=<<<eot
		...
		<div id="footer"></div></div>
			<div id="innerFooter">
    Theme by <a <a href="http://www.marshal.sh.cn" target="_blank">Marshal</a>.
