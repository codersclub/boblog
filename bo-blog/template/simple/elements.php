...
<meta name="keywords" content="{blogkeywords}, Bo-Blog" />
{baseurl}
...
<div class="textbox">
	<div class="textbox-title">
		...
		{entrystar}  |  {entryicon} {entrydatemnamefull} {entrydated}, {entrydatey} @ {entrytime}, {entryauthor}
		</div>
	</div>
...
<div id="commentWrapper" class="comment-wrapper">
	<a name="topreply"></a>
		<div id="com">{entrycommentnum} comment(s)</div>
	<div id="addnew"></div>
eot;
...
$elements['comment']=<<<eot
	<div class="commentbox">	
		...
		<div class="commentbox-content">
			{replycontent}
			<div class="reply" style="display: {ifadminreplied}"  id="replied_{commentid}">
				<div class="reply-content">{adminreplycontent}</div>
				<div class="reply-title">{adminrepliershow}</div>
			</div>
		</div>
		...
		<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" class="formbox-comment">
			...
			<tr>
				...
				<td class="formbox-comment-content" valign="top">
					...
					{ubbcode}
					<textarea name="v_content" id="v_content" cols="64" rows="10" onkeydown="ctrlenterkey(event);"></textarea> <br/>
