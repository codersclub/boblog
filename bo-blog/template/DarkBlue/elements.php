...
<div id="menu"><ul>{section_head_components}</ul></div>
</div>
...
$elements['displayfooter']=<<<eot
	...
	<div id="footer">
	Template By <a href="http://www.tabox.cn">tabox.cn </a>{section_foot_components}
		</div>
	</div>
</div>
eot;
...
<div class="title-entrystar">{entrystar}</div>

<div class="title-right">

<div class="right-top">
<div class="textbox-title"><h4>{entrytitle}</h4></div>
<div class="textbox-label">{entrydatey}-{entrydatem}-{entrydated} {entrytime}</div>
<div class="tags" style="display: {iftags}">{tags} {alltags}</div>
</div>

<div class="bottom-word">{entrycomment} {entrytb} {entryviews} {ifadmin}</div>
...
<div class="right-top">
<div class="textbox-title"><h4>{entrytitletext}</h4></div>
<div class="textbox-label">{entrydatey}-{entrydatem}-{entrydated} {entrytime}</div>
<div class="tags" style="display: {iftags}">{tags} {alltags}</div>
</div>
...
$elements['list']=<<<eot
<tr>
<td class="listbox-entry">{entrycate} {entrytitle}</td>
<td class="listbox-entry">{entryauthor}</td>
<td class="listbox-entry" width="80" align="right">{entrydate}</td>
</tr>
eot;
...
<div class="commentbox-title">{replier} {replieremail} {replierhomepage} {replierip}</div>
<div class="commentbox-time">{replytime}</div>
...
<div class="commentbox-content">
			{replycontent}
			<div class="huifu" style="display: {ifadminreplied}"  id="replied_{commentid}">
				<div class="huifu-title">{adminrepliershow}</div>
				<div class="huifu-content" >{adminreplycontent}</div>
			</div>
		</div>
...
<div class="trackbackbox-title">{tbtitle}</div>
<div class="commentbox-time">{tbtime} {delreply}</div>
...
<table cellspacing="0" width="500px" align="left" class="formbox">
...
<tr><td style="padding-bottom:10px; font-family:verdana; font-size:13px; font-weight:bold; color:#7dbf0e;">{tagcategory}</td></tr>
