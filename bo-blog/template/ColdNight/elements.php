...
$elements['displayfooter']=<<<eot
		...
		<div id="footer">
				...
				<a href="index.php"><!--global:{blogname}--></a> Copyright. | Theme Designed By <a href="http://www.defou.com/">DEFOU</a> | {section_foot_components}
				<div id="processtime">
				</div>
				</div>
		</div>
...
<div class="textbox">
	<div class="textbox-title">
		...
		{entrydate} , {entrycate} , {entrycomment} , {entrytb} , {entryviews} {ifadmin}
		</div>
	</div>
	{tbbar}
	{adminbar}
...
<div class="textbox">
	<div class="textbox-title">
		...
		<div class="textbox-label">
		{entrycate} , {entrycomment} , {entrytb} , {entryviews} {ifadmin} {toolbar}
