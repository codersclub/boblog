...
jslang[28]='Цитата';
jslang[29]='Добавить ссылку у выделенному тексту';
jslang[30]='Текст ссылки';
jslang[31]='Оставьте пустым, если хотите, чтобы текст был таким же как URL';
jslang[32]='Hyperlink';
jslang[33]='Image URL';
jslang[34]='No data.';
jslang[35]='Size ';
...
jslang[38]='Введите hex код цвета';
jslang[39]='Цвет';
...
jslang[78]='Сначала настройте подключаемый модуль CC Video Alliance в управлении подключаемым модулем, вы еще не привязали ID пользователя!';
